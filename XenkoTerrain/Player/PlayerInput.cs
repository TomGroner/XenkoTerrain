...
namespace XenkoTerrain.Player
{
  public class PlayerInput : SyncScript
  {
    ...
    public List<Keys> KeysLeft { get; } = new List<Keys>() { Keys.Left, Keys.A };

    public List<Keys> KeysRight { get; } = new List<Keys>() { Keys.Right, Keys.D };

    public List<Keys> KeysUp { get; } = new List<Keys>() { Keys.Up, Keys.W };

    public List<Keys> KeysDown { get; } = new List<Keys>() { Keys.Down, Keys.S };
